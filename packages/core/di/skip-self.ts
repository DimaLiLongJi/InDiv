...
import { metadataOfSkipSelf } from './metadata';


/**
 * add @SkipSelf in constructor arguments which only can be serached outside of the injector of the current component
 * 
